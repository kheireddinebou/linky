...
// Validate ../../app/(auth)/oauth2/callback/page.tsx
{
  const handler = {} as typeof import("../../app/(auth)/oauth2/callback/page.js")
  handler satisfies AppPageConfig<"/oauth2/callback">
}
